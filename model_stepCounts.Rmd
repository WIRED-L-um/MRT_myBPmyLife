...
```{r}
data = read_excel("C:\\Users\\23300\\University of Michigan Dropbox\\Yuxuan Chen\\myBPmyLife\\Data Analysis\\Data\\MRT\\myBPmyLife MRT Data 20241202.xlsx")

# Use below when you are using your mac
# data = read_excel("//Users//yuxuanchen//University of Michigan Dropbox//Yuxuan Chen//myBPmyLife//Data Analysis//Data//MRT//myBPmyLife MRT Data 20241202.xlsx")
...
```{r}
demo = read_csv("C:\\Users\\23300\\University of Michigan Dropbox\\Yuxuan Chen\\myBPmyLife\\Data Analysis\\Data\\Participants\\August_Analytic_File.csv")
demo$IsRaceWhite = ifelse(demo$race_char == "White",1,0)

# Use below when you are using your mac
# demo = read_csv("/Users/yuxuanchen/University of Michigan Dropbox/Yuxuan Chen/myBPmyLife/Data Analysis/Data/Participants/August_Analytic_File.csv")
...
base_step = read_csv("C:\\Users\\23300\\University of Michigan Dropbox\\Yuxuan Chen\\myBPmyLife\\Data Analysis\\Data\\Participants\\Baseline_Step_Counts20240822.csv")
# Use below when you are using your mac
# base_step = read_csv("/Users/yuxuanchen/University of Michigan Dropbox/Yuxuan Chen/myBPmyLife/Data Analysis/Data/Participants/Baseline_Step_Counts20240822.csv")
...
coreCohortID = readRDS("C:/Users/23300/University of Michigan Dropbox/Yuxuan Chen/myBPmyLife/Data Analysis/Data/MRT/Data Analysis/Explore Data/Code/coreCohortID.rds")
# use below if using mac
coreCohortID = readRDS("/Users/yuxuanchen/University of Michigan Dropbox/Yuxuan Chen/myBPmyLife/Data Analysis/Data/MRT/Data Analysis/Explore Data/Code/coreCohortID.rds")
